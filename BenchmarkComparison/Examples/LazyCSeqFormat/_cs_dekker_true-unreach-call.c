/*  Generated 0.0.0.0.0.0 (-t2 -r11 -u1 -bcbmc) 2015-12-15 06:54:23  */
#include <stdio.h>
#include <stdlib.h>
...
unsigned __CPROVER_bitvector[4] thread_lines[] = {4, 11, 11}; //unsigned __CPROVER_bitvector[4] thread_lines[] = {3, 8, 8};
...
tthr1_0_1: IF(1,1,tthr1_0_2)                           	if (!(flag2 >= 1))
                                                       	{
                                                       		goto __exit_loop_1;
                                                       	}
                                                       	
                                                       	{
tthr1_0_2: IF(1,2,tthr1_0_3)                           		if (turn != 0)
                                                       		{
tthr1_0_3: IF(1,3,tthr1_0_4)                           			flag1 = 0;
tthr1_0_4: IF(1,4,tthr1_0_5)                           			assume(!(turn != 0));
                                                       			;
tthr1_0_5: IF(1,5,tthr1_0_6)                           			flag1 = 1;
                                                       		}
                                                       		GUARD(1,6)
                                                       	}
tthr1_0_6: IF(1,6,tthr1_0_7)                           	assume(!(flag2 >= 1));
                                                       	__exit_loop_1: GUARD(1,7)
                                                       	;
tthr1_0_7: IF(1,7,tthr1_0_8)                           	x = 0;
tthr1_0_8: IF(1,8,tthr1_0_9)                           	if (!(x <= 0))
                                                       	{
                                                       		assert(0);
                                                       	}
                                                       	
                                                       	;
tthr1_0_9: IF(1,9,tthr1_0_10)                          	turn = 1;
tthr1_0_10: IF(1,10,tthr1_0_11)                        	flag1 = 0;
                                                       	__exit_thr1: GUARD(1,11)
                                                       	;
tthr1_0_11:                                            	STOP_NONVOID(11);
                                                       }
...
tthr2_0_1: IF(2,1,tthr2_0_2)                           	if (!(flag1 >= 1))
                                                       	{
                                                       		goto __exit_loop_2;
                                                       	}
                                                       	
                                                       	{
tthr2_0_2: IF(2,2,tthr2_0_3)                           		if (turn != 1)
                                                       		{
tthr2_0_3: IF(2,3,tthr2_0_4)                           			flag2 = 0;
tthr2_0_4: IF(2,4,tthr2_0_5)                           			assume(!(turn != 1));
                                                       			;
tthr2_0_5: IF(2,5,tthr2_0_6)                           			flag2 = 1;
                                                       		}
                                                       		GUARD(2,6)
                                                       	}
tthr2_0_6: IF(2,6,tthr2_0_7)                           	assume(!(flag1 >= 1));
                                                       	__exit_loop_2: GUARD(2,7)
                                                       	;
tthr2_0_7: IF(2,7,tthr2_0_8)                           	x = 1;
tthr2_0_8: IF(2,8,tthr2_0_9)                           	if (!(x >= 1))
                                                       	{
                                                       		assert(0);
                                                       	}
                                                       	
                                                       	;
tthr2_0_9: IF(2,9,tthr2_0_10)                          	turn = 1;
tthr2_0_10: IF(2,10,tthr2_0_11)                        	flag2 = 0;
                                                       	__exit_thr2: GUARD(2,11)
                                                       	;
tthr2_0_11:                                            	STOP_NONVOID(11);
                                                       }
...
tmain_4:                                               	STOP_NONVOID(4);
                                                       ...
                                                       int main(void) {
                                                                 ...
                                                                 unsigned __CPROVER_bitvector[8] top1 = 11;
                                                                 ...
                                                                 assume(sum1 <= top1);
                                                                 unsigned __CPROVER_bitvector[8] top2 = 11;
