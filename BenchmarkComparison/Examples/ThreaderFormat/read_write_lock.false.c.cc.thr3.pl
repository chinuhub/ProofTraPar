...
r(p(pc(thr3-2-0), data(V3, V1, V2)), p(pc(thr3-1-34), data(V3, V1, V2)), [], [], 2). % 
stmtsrc(2, 'skip;').
transition_access( 2, [_, _, _] ).
r(p(pc(thr3-1-34), data(V3, V1, V2)), p(pc(thr3-4-0), data(V3, V1, V2)), [(V1 = 0)], [], 3). % w == 0
...
r(p(pc(thr3-5-0), data(V3, V1, V2)), p(pc(thr3-3-37), data(V3, V1p, V2)), [], [V1p = 1], 5). % w := 1
stmtsrc(5, 'w=1;').
transition_access( 5, [_, w, _] ).
r(p(pc(thr3-3-37), data(V3, V1, V2)), p(pc(thr3-7-0), data(V3p, V1, V2)), [], [V3p = 3], 6). % x := 3
stmtsrc(6, 'x=3;').
transition_access( 6, [w, _, _] ).
r(p(pc(thr3-7-0), data(V3, V1, V2)), p(pc(thr3-6-38), data(V3, V1p, V2)), [], [V1p = 0], 7). % w := 0
stmtsrc(7, 'w=0;').
transition_access( 7, [_, w, _] ).
r(p(pc(thr3-6-38), data(V3, V1, V2)), p(pc(thr3-ret-0), data(V3, V1, V2)), [], [], 8). % 
stmtsrc(8, 'skip;').
transition_access( 8, [_, _, _] ).
% Atomic blocks
atomic(pc(thr3-1-34),pc(thr3-3-37),[5, 4, 3]).
% Strengthenings
