...
svcompparams = []
svcompparams = []
svcompparams.append('-T200 -f1 -s -F50 -w1 -r2 -d800 -bcbmc ')  
svcompparams.append('-T200 -f2 -w2 -r2 -d200 -bcbmc')
svcompparams.append('-T200 -f4 -w4 -r1 -d150 -bcbmc')
svcompparams.append('-T200 -f16 -w1 -r1 -d350 -bcbmc')
svcompparams.append('-T800 -f1 -s -F11 -w1 -r11 -d300 -bcbmc')
