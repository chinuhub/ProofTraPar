...
int PIo31; // local variable of stopper
int pc1, pc2, pc3;
int NONDET ;
...
int main() {
  ...
  while (1) {
	...
	switch (pc3) {
	case 1:
	  driverStoppingFlag = 1; pc3 = 2; break;
	case 2:
	  PIo31 = pendingIo - 1; pc3 = 3; break;
	case 3:
	  pendingIo = pendingIo - 1; pc3 = 4; break;
	case 4:
	  if (PIo31 == 0) {
	    pc3 = 5; break;
	  } else {
