...
/**
 * Language Reverse
 * Added by chinmay .. (chinu.pandey@gmail.com)
 *
 * Convert the input generator to another one that accepts the reverse of
 * marked language of input generator
 */

void LanguageReverse(Generator& rGen);
