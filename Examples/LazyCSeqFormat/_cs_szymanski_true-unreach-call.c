/*  Generated 0.0.0.0.0.0 (-t2 -r11 -u1 -bcbmc) 2015-12-15 06:56:07  */
#include <stdio.h>
#include <stdlib.h>
...
unsigned __CPROVER_bitvector[4] thread_lines[] = {4, 12, 12}; //unsigned __CPROVER_bitvector[4] thread_lines[] = {3, 8, 8};
...
tthr1_0_1: IF(1,1,tthr1_0_2)                           	assume(!(flag2 >= 3));
tthr1_0_2: IF(1,2,tthr1_0_3)                           	flag1 = 3;
tthr1_0_3: IF(1,3,tthr1_0_4)                           	if (flag2 == 1)
                                                       	{
tthr1_0_4: IF(1,4,tthr1_0_5)                           		flag1 = 2;
tthr1_0_5: IF(1,5,tthr1_0_6)                           		assume(!(flag2 != 4));
                                                       	}
                                                       	GUARD(1,6)
tthr1_0_6: IF(1,6,tthr1_0_7)                           	flag1 = 4;
tthr1_0_7: IF(1,7,tthr1_0_8)                           	assume(!(flag2 >= 2));
tthr1_0_8: IF(1,8,tthr1_0_9)                           	x = 0;
tthr1_0_9: IF(1,9,tthr1_0_10)                          	if (!(x <= 0))
                                                       	{
                                                       		assert(0);
                                                       	}
                                                       	
                                                       	;
tthr1_0_10: IF(1,10,tthr1_0_11)                        	assume(!((2 <= flag2) && (flag2 <= 3)));
tthr1_0_11: IF(1,11,tthr1_0_12)                        	flag1 = 0;
                                                       	__exit_thr1: GUARD(1,12)
                                                       	;
tthr1_0_12:                                            	STOP_NONVOID(12);
                                                       }
...
tthr2_0_1: IF(2,1,tthr2_0_2)                           	assume(!(flag1 >= 3));
tthr2_0_2: IF(2,2,tthr2_0_3)                           	flag2 = 3;
tthr2_0_3: IF(2,3,tthr2_0_4)                           	if (flag1 == 1)
                                                       	{
tthr2_0_4: IF(2,4,tthr2_0_5)                           		flag2 = 2;
tthr2_0_5: IF(2,5,tthr2_0_6)                           		assume(!(flag1 != 4));
                                                       	}
                                                       	GUARD(2,6)
tthr2_0_6: IF(2,6,tthr2_0_7)                           	flag2 = 4;
tthr2_0_7: IF(2,7,tthr2_0_8)                           	assume(!(flag1 >= 2));
tthr2_0_8: IF(2,8,tthr2_0_9)                           	x = 1;
tthr2_0_9: IF(2,9,tthr2_0_10)                          	if (!(x >= 1))
                                                       	{
                                                       		assert(0);
                                                       	}
                                                       	
                                                       	;
tthr2_0_10: IF(2,10,tthr2_0_11)                        	assume(!((2 <= flag1) && (flag1 <= 3)));
tthr2_0_11: IF(2,11,tthr2_0_12)                        	flag2 = 0;
                                                       	__exit_thr2: GUARD(2,12)
                                                       	;
tthr2_0_12:                                            	STOP_NONVOID(12);
                                                       }
...
tmain_4:                                               	STOP_NONVOID(4);
                                                       ...
                                                       int main(void) {
                                                                 ...
                                                                 unsigned __CPROVER_bitvector[8] top1 = 12;
                                                                 ...
                                                                 assume(sum1 <= top1);
                                                                 unsigned __CPROVER_bitvector[8] top2 = 12;
                                                                 unsigned __CPROVER_bitvector[8] sum2 = tmp_t2_r0 + tmp_t2_r1 + tmp_t2_r2 + tmp_t2_r3 + tmp_t2_r4 + tmp_t2_r5 + tmp_t2_r6 + tmp_t2_r7 + tmp_t2_r8 + tmp_t2_r9 + tmp_t2_r10;
                                                                 assume(sum2 <= top2);
                                                                 // round 0
                                                                 thread_index = 0;
