/*  Generated 0.0.0.0.0.0 (-t3 -r2 -u1 -bcbmc) 2015-12-15 06:56:58  */
#include <stdio.h>
#include <stdlib.h>
...
IF(3,0,tqrcu_updater_0_1)                              	__cs_init_scalar(&__csLOCAL_qrcu_updater_i, sizeof(int));
                                                       	static int __csLOCAL_qrcu_updater_readerstart1 = __VERIFIER_nondet_int();
                                                       	static int __csLOCAL_qrcu_updater_readerstart2 = __VERIFIER_nondet_int();
...
tmain_7:                                               	STOP_NONVOID(7);
                                                       ...
                                                       int main(void) {
                                                                 ...
                                                                 unsigned __CPROVER_bitvector[6] top3 = 24;
                                                                 unsigned __CPROVER_bitvector[6] sum3 = tmp_t3_r0 + tmp_t3_r1;
                                                                 assume(sum3 <= top3);
                                                                 // round 0
                                                                 thread_index = 0;
